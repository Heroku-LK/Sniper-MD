...
if (!fs.existsSync(__dirname + '/session/creds.json')) {
  ...
  const sessdata = config.SESSION_ID.replace("Sniper=","")
...
await connectdb()
await updb()
console.log('Sniper-MD connected ♨️')
    }
  })
...
mediaType: 1,
sourceUrl: "https://wa.me/94776713391" ,
thumbnailUrl: 'https://i.ibb.co/GnrGf3T/tj9-Thmm-T6628.jpg' ,
...
body: 'ᴀ ꜱɪᴍᴘʟᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ',
mediaType: 1,
sourceUrl: "https://wa.me/94775713391" ,
thumbnailUrl: 'https://i.ibb.co/GnrGf3T/tj9-Thmm-T6628.jpg' ,
renderLargerThumbnail: false,
showAdAttribution: true
}
...
app.get("/", (req, res) => {
  res.send("📟 Dilisha Working successfully!");
});
